export const WORKFLOW_STEPS = [
  ...
  { key: 'categories', label: 'Susun kategori hasil', description: 'Definisikan kategori yang akan menjadi keluaran klasifikasi atau rekomendasi.' },
  ...
  { key: 'rules', label: 'Atur Rule Base', description: 'Susun rule dan kondisi untuk mengelompokkan alternatif ke kategori yang sesuai.' },
